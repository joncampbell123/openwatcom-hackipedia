...
/* TODO: When compiling for win32s, put a #define here that tells
         other projects (such as the "dos" and "doslib2" code) that
         the fixes are built into the clib and the w32imphk library
         is unnecessary */
...
/* TODO: Jonathan C -- Consider setting this _OLD_WINNT_COMPATIBLE #define
         when targeting "win32s" because the Windows 3.1 Win32s environment
