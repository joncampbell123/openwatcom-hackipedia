...
/* This signals to our existing DOSLIB projects the integration
   of Win32s support and that we no longer need the w32imphk
   hackjob library -- J.C. */
#define __JC_OW_PROPER_WIN32s 1
 ...
 */
#if defined(_OLD_WINNT_COMPATIBLE) || WINVER < 0x400
